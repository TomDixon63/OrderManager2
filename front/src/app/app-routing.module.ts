        ...
        RouterModule.forRoot([
            {
                ...
                children: [
                    ...
                    { path: 'bestellungen-uebermorgen', loadChildren: () => import('./manager/components/bestellungen-uebermorgen/bestellungen-uebermorgen.module').then(m => m.BestellungenUebermorgenModule) },
